...
public class IntegratedSellingPointsController implements IntegratedSellingPointsApi {
	...
	@Override
	public Mono<ResponseEntity<String>> add(SellingPointDocument sellingPointDocument) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Mono<ResponseEntity<String>> update(SellingPointDocument sellingPointDocument) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Mono<ResponseEntity<String>> delete(int id) {
		// TODO Auto-generated method stub
		return null;
	}
